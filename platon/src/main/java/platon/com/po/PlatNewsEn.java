...
@Table(name="plat_news_en")
public class PlatNewsEn extends Params{
    private Integer id;
    ...
    private List<PlatTypeEn> typsList;  //用户查询 观点分类时，去掉 新闻分类和活动
	...
	public List<PlatTypeEn> getTypsList() {
		return typsList;
	}

	public void setTypsList(List<PlatTypeEn> typsList) {
