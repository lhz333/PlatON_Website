...
import static com.jdbcTemplateTool.utils.CatalogUtils.changeCatalog;
...
import com.jdbcTemplateTool.impl.ReturnIdPreparedStatementCreator;

public class JdbcTemplateProxy {
	
	private JdbcTemplate jdbcTemplate;

	private static final Logger logger=Logger.getLogger(JdbcTemplateProxy.class);
...
//	private static String changIn
	...
	public int insert(String sql,Object[] params,String autoGeneratedColumnName)
		...
		try{
			jdbcTemplate.update((PreparedStatementCreator) psc, keyHolder);
		}catch(DataAccessException e){
			StringBuilder sb = new StringBuilder();
			sb.append("[");
			for(Object p:params){
