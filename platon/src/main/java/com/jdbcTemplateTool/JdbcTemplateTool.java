...
import com.jdbcTemplateTool.exception.NoDefinedGetterException;
import com.jdbcTemplateTool.exception.NoIdAnnotationFoundException;
import com.jdbcTemplateTool.impl.BatchUpdateSetter;
import com.jdbcTemplateTool.model.SqlParamsPairs;
import com.jdbcTemplateTool.page.Page;
import com.jdbcTemplateTool.page.Pagination;
import com.jdbcTemplateTool.page.Sort;
import com.jdbcTemplateTool.utils.IdUtils;
import com.jdbcTemplateTool.utils.ModelSqlUtils;
...
public class JdbcTemplateTool {
	...
	private static final Logger logger=Logger.getLogger(JdbcTemplateTool.class);
