...
public class HttpSender {
    ...
    public static void main(String[] args) {
		...
		try {
			...
			String page="{\"pageNo\":\"1\",\"pageSzie\":\"10\"}";
//			res = sendPost("http://192.168.10.181/platon/news/findNewsEnInfoMobileOnline.do", page,headers);
			res = sendPost("https://mg.platon.networkwork/platon/news/findNewsEnInfoMobileOnline.do", page,headers);
