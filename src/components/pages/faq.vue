...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //查看
            seeNews() {
                window.open("https://www.platon.network/index.html#/faq");
            },
            //记录
            record(row) {
                let _this = this;
        ...
        mounted() {
            let faqPagesize = window.sessionStorage.getItem('faqPagesize');
            if(faqPagesize && faqPagesize !== null){
                this.page.pageSize = parseInt(faqPagesize);
            }
            this.getData();
        }
    }
